...
# Funzies
text1Font = pygame.font.SysFont('Times New Roman', 48)
text2Font = pygame.font.SysFont('Times New Roman', 24)
text1 = text1Font.render('YOU DIED', True, RED, BLACK)
text2 = text2Font.render('from consumption...', True, WHITE, BLACK)
text1Rect = text1.get_rect()
text2Rect = text2.get_rect()
text1Rect.centerx = windowSurface.get_rect().centerx
text1Rect.centery = windowSurface.get_rect().centery - text1Rect.height
...
pygame.mixer.music.load(os.path.abspath("curb.mp3"))
